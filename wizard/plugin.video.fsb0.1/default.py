...
base='https://github.com/sm1thy16/fsb/tree/master/wizard'
ADDON=xbmcaddon.Addon(id='plugin.video.fsb')
...
def CATEGORIES():
    link = OPEN_URL('https://github.com/sm1thy16/fsb/blob/master/wizard/wizard_test.txt').replace('\n','').replace('\r','')
